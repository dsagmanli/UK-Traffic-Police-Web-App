/* IMPORTANT NOTE TO MARKERS: I HAVE MODIFIED THE GIVEN DATABASE 
* BUT HAVE NOT FILLED IN THE NEW TABLES I ADDED. WHEN YOU ARE TESTING 
* THE FEATURES, THE DATABASE WILL POPULATE ITSELF. PLEASE CHECK AUDIT 
* TRAIL LAST.
*/
